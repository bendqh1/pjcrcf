<div class="prcf_form_middle_3">
    <div class="flex_child_right">
        <div><label for="prcf_input_url" id="prcf_label_url" class="prcf_label">כתובת אתר אינטרנט</label></div>
        <input type="text" dir="ltr" name="url" id="prcf_input_url" class="prcf_item"></input>
    </div>
    <div class="flex_child_left">
        <div><label for="prcf_input_notes" id="prcf_label_notes" class="prcf_label">הערות</label></div>
